...
This file is the quick-reference operating contract for ignore-kotlin. The longer
...
ignore-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`ignore`](https://crates.io/crates/ignore). Upstream Rust is the behavioral oracle while the
