# ignore-kotlin in Kotlin

[![GitHub link](https://img.shields.io/badge/GitHub-KotlinMania%2Fignore--kotlin-blue.svg)](https://github.com/KotlinMania/ignore-kotlin)
[![Maven Central](https://img.shields.io/maven-central/v/io.github.kotlinmania/ignore-kotlin)](https://central.sonatype.com/artifact/io.github.kotlinmania/ignore-kotlin)
[![Build status](https://img.shields.io/github/actions/workflow/status/KotlinMania/ignore-kotlin/ci.yml?branch=main)](https://github.com/KotlinMania/ignore-kotlin/actions)

This is a Kotlin Multiplatform line-by-line transliteration port of [`BurntSushi/ripgrep`](https://github.com/BurntSushi/ripgrep/tree/master/crates/ignore).

**Original Project:** This port is based on [`BurntSushi/ripgrep`](https://github.com/BurntSushi/ripgrep/tree/master/crates/ignore). All design credit and project intent belong to the upstream authors; this repository is a faithful port to Kotlin Multiplatform with no behavioural changes intended.
...
## Upstream README — `BurntSushi/ripgrep`

> The text below is reproduced and lightly edited from [`https://github.com/BurntSushi/ripgrep/tree/master/crates/ignore`](https://github.com/BurntSushi/ripgrep/tree/master/crates/ignore). It is the upstream project's own description and remains under the upstream authors' authorship; links have been rewritten to absolute upstream URLs so they continue to resolve from this repository.
...
Please see the [CHANGELOG](https://github.com/BurntSushi/ripgrep/blob/HEAD/CHANGELOG.md) for a release history.

### Documentation quick links

* [Installation](#installation)
* [User Guide](https://github.com/BurntSushi/ripgrep/blob/HEAD/GUIDE.md)
* [Frequently Asked Questions](https://github.com/BurntSushi/ripgrep/blob/HEAD/FAQ.md)
* [Regex syntax](https://docs.rs/regex/1/regex/#syntax)
* [Configuration files](https://github.com/BurntSushi/ripgrep/blob/HEAD/GUIDE.md#configuration-file)
* [Shell completions](https://github.com/BurntSushi/ripgrep/blob/HEAD/FAQ.md#complete)
* [Building](#building)
...
* It can replace many use cases served by other search tools
  ...
  [the FAQ](https://github.com/BurntSushi/ripgrep/blob/HEAD/FAQ.md#posix4ever) for more details on whether ripgrep can truly
  replace grep.)
* Like other tools specialized to code search, ripgrep defaults to
  [recursive search](https://github.com/BurntSushi/ripgrep/blob/HEAD/GUIDE.md#recursive-search) and does [automatic
  filtering](https://github.com/BurntSushi/ripgrep/blob/HEAD/GUIDE.md#automatic-filtering). Namely, ripgrep won't search files
...
* ripgrep can [search specific types of files](https://github.com/BurntSushi/ripgrep/blob/HEAD/GUIDE.md#manual-filtering-file-types).
...
* ripgrep has [rudimentary support for replacements](https://github.com/BurntSushi/ripgrep/blob/HEAD/GUIDE.md#replacements),
  which permit rewriting output based on what was matched.
* ripgrep supports [searching files in text encodings](https://github.com/BurntSushi/ripgrep/blob/HEAD/GUIDE.md#file-encoding)
...
* ripgrep supports
  [arbitrary input preprocessing filters](https://github.com/BurntSushi/ripgrep/blob/HEAD/GUIDE.md#preprocessor)
  which could be PDF text extraction, less supported decompression, decrypting,
  automatic encoding detection and so on.
* ripgrep can be configured via a
  [configuration file](https://github.com/BurntSushi/ripgrep/blob/HEAD/GUIDE.md#configuration-file).
...
```kotlin
dependencies {
    implementation("io.github.kotlinmania:ignore-kotlin:0.1.1")
}
```
...
This Kotlin port is distributed under the same Unlicense license as the upstream [`BurntSushi/ripgrep`](https://github.com/BurntSushi/ripgrep/tree/master/crates/ignore). See [LICENSE](LICENSE) (and any sibling `LICENSE-*` / `NOTICE` files mirrored from upstream) for the full text.

Original work copyrighted by the ripgrep authors.  
Kotlin port: Copyright (c) 2026 Sydney Renee and The Solace Project.

### Acknowledgments

Thanks to the [`BurntSushi/ripgrep`](https://github.com/BurntSushi/ripgrep/tree/master/crates/ignore) maintainers and contributors for the original Rust implementation. This port reproduces their work in Kotlin Multiplatform; bug reports about upstream design or behavior should go to the upstream repository.
