...
fun installProjectAndroidSdk(execOperations: ExecOperations) {
    ...
    val missingPackageDirs = requiredAndroidSdkPackageDirs.filterNot { it.exists() }
    if (missingPackageDirs.isNotEmpty()) {
        throw GradleException(
            "Android SDK install completed but required packages are missing: " +
                missingPackageDirs.joinToString(),
        )
    }
...
// task graph, before any task executes, so the project-local SDK must already
...
kotlin {
    ...
    val xcf = XCFramework("Ignore")

    macosArm64 {
        binaries.framework { baseName = "Ignore"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "Ignore"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "Ignore"
        flattenPackage = "io.github.kotlinmania.ignore"
    }

    android {
        namespace = "io.github.kotlinmania.ignore"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "ignore-kotlin", version.toString())
    ...
    pom {
        ...
        scm {
            url.set("https://github.com/KotlinMania/ignore-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/ignore-kotlin.git")
...
val codeqlCompileJvm = tasks.register<JavaExec>("codeqlCompileJvm") {
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            val sentinelFile = sentinelDir.get().asFile.resolve("io/github/kotlinmania/ignore/codeql/_CodeqlEmptySource.kt")
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.ignore.codeql
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleDebugIosFatFrameworkForIgnoreXCFramework",
    "assembleReleaseIosFatFrameworkForIgnoreXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForIgnoreXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForIgnoreXCFramework",
    "assembleDebugMacosFatFrameworkForIgnoreXCFramework",
    "assembleReleaseMacosFatFrameworkForIgnoreXCFramework",
    "assembleDebugTvosFatFrameworkForIgnoreXCFramework",
    "assembleReleaseTvosFatFrameworkForIgnoreXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForIgnoreXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForIgnoreXCFramework",
    "assembleDebugWatchosFatFrameworkForIgnoreXCFramework",
    "assembleReleaseWatchosFatFrameworkForIgnoreXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForIgnoreXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForIgnoreXCFramework",
